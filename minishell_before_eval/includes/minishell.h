...
void		process_heredoc_redir(t_redir *r, t_shell *shell, t_cmd *cmd);
void		handle_heredoc(t_cmd *cmd, t_shell *shell);

/* execute5.c */
void		cleanup_and_exit(t_shell *shell, t_cmd *cmd, char **env_array, \
	int code);
void		handle_directory_error(t_cmd *cmd, t_shell *shell, \
	char **env_array);
void		handle_permission_error(t_cmd *cmd, t_shell *shell, \
	char **env_array);
void		handle_file_not_found(t_cmd *cmd, t_shell *shell, \
	char **env_array);
void		check_file_and_execute(t_cmd *cmd, t_shell *shell, \
	char **env_array);
